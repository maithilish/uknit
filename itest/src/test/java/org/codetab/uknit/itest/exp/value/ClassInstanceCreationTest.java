...
class ClassInstanceCreationTest {
    ...
    public void testArgIsCast() {
        ...
        verify(foo, times(2)).appendBox(new Box(name));
        verify(foo).appendBox(new Box(city));
    }
    ...
    public void testArgIsMethodRef() {
        ...
        verify(foo, times(3)).appendBox(new Box("foo", String::toUpperCase));
    }
    ...
    public void testArgIsLambda() {
        ...
        verify(foo, times(3)).appendObj(new Box(name, s -> s.toUpperCase()));
    }
    ...
    public void testArgIsPostfix() {
        ...
        verify(foo).appendObj(new Box(0));
        verify(foo).appendObj(new Box(1));
        verify(foo).appendObj(new Box(10));
    }
    ...
    public void testArgIsPrefix() {
        ...
        verify(foo).appendObj(new Box(-1));
        verify(foo).appendObj(new Box(-2));
        verify(foo).appendObj(new Box(9));
    }
