...
class ConditionalTest {
    ...
    public void testExpIsArrayAccess() {
        ...
        verify(foo, times(1)).appendString(mango ? "yes" : "no");
    }
    ...
    public void testChoiceIsArrayCreation() {
        ...
        verify(foo, times(2)).appendString(code ? apple : grape);
        verify(foo, times(2))
                .appendString(code2 ? new String[] {"foo", "bar"}[0]
    ...
    public void testChoiceIsInstanceCreation() {
        ...
        verify(foo, times(2))
                .appendObj(flag ? new String("foo") : new String("bar"));
    }
    ...
    public void testExpIsConditional() {
        ...
        verify(foo, times(2))
                .appendString((flag ? true : false) ? "foo" : "bar");
    ...
    public void testChoiceIsConditional() {
        ...
        verify(foo, times(2))
                .appendString(flag ? (code ? "foo" : "bar") : "bar");
    }
    ...
    public void testChoiceIsInstanceof() {
        ...
        verify(foo, times(2))
                .appendObj(flag ? o instanceof String : o instanceof Integer);
    }
    ...
    public void testChoiceIsPostfix() {
        ...
        verify(foo).appendObj(apple ? 11 : 21);
        verify(foo).appendObj(apple ? 12 : 22);
    }
    ...
    public void testChoiceIsPrefix() {
        ...
        // verify(foo, times(2)).appendObj(apple ? --a : --b);
        verify(foo).appendObj(apple ? 10 : 20);
        verify(foo).appendObj(apple ? 9 : 19);
    }
    ...
    public void testChoiceIsThis() {
        ...
        verify(foo, times(2)).appendString(
                conditional.fflag ? conditional.ffoo : conditional.fbar);
    }
