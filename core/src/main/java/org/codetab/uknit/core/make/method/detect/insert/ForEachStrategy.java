...
public class ForEachStrategy {
    ...
    public Optional<Insert> process(final IVar var, final Class<?> clz,
        ...
        if (inserters.requiresKey(clz)) {
             ...
             */
            List<ExpVar> expVars = inserters.findAllowedExpVars(var, clz, heap);
            if (!expVars.isEmpty()) {
                ...
                if (inferVarO.isEmpty()) {
                    Expression rExp = expVars.get(0).getRightExp();
                ...
                if (inferVarO.isPresent()) {
                    ...
                    String invokedMethod = inserters
                            .getInvokedMethod(expVars.get(0).getRightExp());
