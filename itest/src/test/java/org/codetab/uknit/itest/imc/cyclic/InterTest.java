...
class InterTest {
    ...
    public void testCallInterCyclic21() {
        ...
        verify(foo, times(3)).append("imc23 before");
        verify(foo, times(3)).append("imc24 before");
        verify(foo, times(1)).append("imc25 before");
        verify(foo, times(1)).append("imc25 after");
        verify(foo, times(3)).append("imc24 after");
        verify(foo, times(3)).append("imc23 after");
    ...
    public void testCallZigZagCyclic21() {
        ...
        verify(foo, times(3)).append("imc32 before");
        verify(foo, times(3)).append("imc33 before");
        ...
        verify(foo, times(3)).append("imc33 after");
        verify(foo, times(3)).append("imc32 after");
    }
}
